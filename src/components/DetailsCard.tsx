      ...
      <CellGrid>
        ...
        {options.map((opt) => (
          <GridCell
            ...
            title={opt.ja}
            onClick={() =>
              onChange(value === opt.id ? "skip" : opt.id)
            }
          />
        ))}
      </CellGrid>
...
function HairContent({ d, upd, chg }: { d: DetailSettings; upd: Updater; chg: (n: DetailSettings) => void }) {
  ...
  return (
    <div>
      ...
      <FieldSection label="質感" value={d.hair.texture} options={HAIR_TEXTURES}
      ...
      <FieldSection label="毛先" value={d.hair.tips} options={HAIR_TIPS}
      ...
      <FieldSection label="アクセサリー" value={d.hair.accessory} options={HAIR_ACCESSORIES}
...
function BackgroundContent({ d, upd, chg }: { d: DetailSettings; upd: Updater; chg: (n: DetailSettings) => void }) {
  ...
  return (
    <div>
      ...
      <FieldSection label="背景スタイル" value={d.background.style ?? "skip"} options={BG_STYLES}
      ...
      <FieldSection label="色" value={d.background.color} options={BG_COLORS}
      ...
      <FieldSection label="空間効果" value={d.background.effect} options={BG_EFFECTS}
...
function PoseContent({ d, upd }: { d: DetailSettings; upd: Updater }) {
  return (
    <div>
      ...
      <FieldSection label="印象" value={d.pose.impression} options={POSE_IMPRESSIONS}
      ...
      <FieldSection label="手の位置" value={d.pose.hand} options={POSE_HANDS}
        onChange={(v) => upd("pose", { hand: v as DetailSettings["pose"]["hand"] })} />
      <FieldSection label="足の位置" value={d.pose.foot} options={POSE_FEET}
      ...
      <FieldSection label="動き" value={d.pose.motion} options={POSE_MOTIONS}
...
function PropsContent({ d, upd, chg }: { d: DetailSettings; upd: Updater; chg: (n: DetailSettings) => void }) {
  return (
    <div>
      ...
      <FieldSection label="持たせ方" value={d.props.hold} options={PROPS_HOLDS}
      ...
      <FieldSection label="雰囲気" value={d.props.vibe} options={PROPS_VIBES}
        onChange={(v) => upd("props", { vibe: v as DetailSettings["props"]["vibe"] })} />
      <FieldSection label="配置" value={d.props.placement} options={PROPS_PLACEMENTS}
...
function BigObjectContent({ d, upd, chg }: { d: DetailSettings; upd: Updater; chg: (n: DetailSettings) => void }) {
  ...
  return (
    <div>
      ...
      <FieldSection label="状態" value={d.bigObject.condition} options={BIG_OBJECT_CONDITIONS}
      ...
      <FieldSection label="雰囲気" value={d.bigObject.mood} options={BIG_OBJECT_MOODS}
...
function VehicleContent({ d, upd }: { d: DetailSettings; upd: Updater }) {
  return (
    <div>
      ...
      <FieldSection label="素材感" value={d.vehicle.material} options={VEHICLE_MATERIALS}
        onChange={(v) => upd("vehicle", { material: v as DetailSettings["vehicle"]["material"] })} />
      <FieldSection label="雰囲気" value={d.vehicle.atmosphere} options={VEHICLE_ATMOSPHERES}
...
function MythContent({ d, upd, chg }: { d: DetailSettings; upd: Updater; chg: (n: DetailSettings) => void }) {
  ...
  return (
    <div>
      ...
      <FieldSection label="配置・関わり方" value={d.myth.interaction} options={MYTH_INTERACTIONS}
        onChange={(v) => upd("myth", { interaction: v as DetailSettings["myth"]["interaction"] })} />
      <FieldSection label="描写スタイル" value={d.myth.style} options={MYTH_STYLES}
...
function LightingContent({ d, upd, chg }: { d: DetailSettings; upd: Updater; chg: (n: DetailSettings) => void }) {
  ...
  return (
    <div>
      ...
      <FieldSection label="空気感" value={d.lighting.atmosphere} options={LIGHT_ATMOSPHERES}
...
function CosplayContent({ d, upd }: { d: DetailSettings; upd: Updater }) {
  return (
    <div>
      <FieldSection label="ジャンル系統" value={d.cosplay.genre} options={COSPLAY_GENRES} noTopMargin
      ...
      <FieldSection label="持ち物・小物" value={d.cosplay.item} options={COSPLAY_ITEMS}
      ...
      <FieldSection label="カラー方向" value={d.cosplay.colorDir} options={COSPLAY_COLOR_DIRS}
...
function ForegroundContent({ d, upd }: { d: DetailSettings; upd: Updater }) {
  return (
    <div>
      ...
      <FieldSection label="エフェクト種類" value={d.foreground.effectType} options={FG_EFFECT_TYPES}
        onChange={(v) => upd("foreground", { effectType: v as DetailSettings["foreground"]["effectType"] })} />
      <FieldSection label="回転・渦" value={d.foreground.swirlType} options={FG_SWIRL_TYPES}
        onChange={(v) => upd("foreground", { swirlType: v as DetailSettings["foreground"]["swirlType"] })} />
      <FieldSection label="HUD・デジタル" value={d.foreground.digitalType} options={FG_DIGITAL_TYPES}
        onChange={(v) => upd("foreground", { digitalType: v as DetailSettings["foreground"]["digitalType"] })} />
      <FieldSection label="アート表現" value={d.foreground.artType} options={FG_ART_TYPES}
        onChange={(v) => upd("foreground", { artType: v as DetailSettings["foreground"]["artType"] })} />
      <FieldSection label="位置" value={d.foreground.position} options={FG_POSITIONS}
      ...
      <FieldSection label="動き" value={d.foreground.motion} options={FG_MOTIONS}
        onChange={(v) => upd("foreground", { motion: v as DetailSettings["foreground"]["motion"] })} />
      <FieldSection label="色方向" value={d.foreground.color} options={FG_COLORS}
