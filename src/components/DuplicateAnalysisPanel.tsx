...
interface Props {
  ...
  initialTab?:       "dup" | "discovery" | "agent" | "color" | "image" | "pref" | "rank" | "skyveil";
...
function DuplicateAnalysisPanelInner({
  ...
  const [tab, setTab] = useState<"dup" | "discovery" | "agent" | "color" | "image" | "pref" | "rank" | "skyveil">(initialTab ?? "dup");
  // 🔭発見タブ（未開拓発見担当）
