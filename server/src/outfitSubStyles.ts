...
export const SUB_STYLE_POOLS: Readonly<Record<string, readonly SubStyleDef[]>> = {
  ...
  lolita: [
    { id: "lo_sweet",         label: "スイートロリィタ" },
    { id: "lo_gothic",        label: "ゴシックロリィタ" },
    { id: "lo_classical",     label: "クラシカルロリィタ" },
    { id: "lo_punk",          label: "パンクロリィタ" },
    { id: "lo_wa",            label: "和ロリィタ" },
    { id: "lo_country",       label: "カントリーロリィタ" },
    { id: "lo_modern",        label: "モダンロリィタ" },
    { id: "lo_pink",          label: "ピンクロリィタ" },
    { id: "lo_black",         label: "黒ロリィタ" },
    { id: "lo_white",         label: "白ロリィタ" },
    { id: "lo_victorian",     label: "ヴィクトリアンロリィタ" },
    { id: "lo_dark",          label: "ダークロリィタ" },
  ],
  uniform: [
    { id: "uni_sailor",       label: "セーラー服スタイル" },
    { id: "uni_gakuran",      label: "学ランスタイル" },
    { id: "uni_blazer",       label: "ブレザー制服" },
    { id: "uni_jk_street",    label: "JKストリート風制服" },
