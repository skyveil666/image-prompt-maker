...
function bodyFixBlock(): string {
  return [
    ...
    "・頭身・体型比率の等身ガード：約8〜9頭身を保ち、頭身・脚の長さ・顔の大きさ・体型比率を元画像基準に維持する。魚眼・広角・煽り・俯瞰などの歪み系アングルは使わない。標準〜ポートレートレンズで体を縦に引き伸ばさない。",
    "─ 出力時の文例（そのまま使ってよい）─",
...
function cameraAggressionBlock(): string {
  return [
    ...
    "  目線の高さの斜め45度 / 標準レンズ感の自然な構図 / 控えめな斜め45度の見下ろし /",
    ...
    "  レンズは標準〜ポートレートレンズに固定する。魚眼・誇張広角・地面すれすれの超ローアングル・強い俯瞰/煽りは絶対に使わない（体や脚が伸びて歪むため）。",
    "  人物は画面内で主役の大きさを保ち、豆粒化・遠景の点景にしない。アングルの演出より人物の比率（元画像基準の自然な頭身）を優先する。",
    "  Use standard-to-portrait lens ONLY; do not use fisheye, ultra-wide, ground-level low-angle, or strong high/low angles. Keep the subject prominent and proportions matched to the reference (no leg/torso elongation).",
    "",
    "▼ カメラを確定する前の確認：",
    "  □ 「正面バストアップ」「正面全身」がデフォルトになっていないか",
    "  □ このカメラアングルが“単調でない自然さ”を持っているか",
    "  □ 各案でカメラアングルが明確に異なるか",
    "  □ 魚眼・誇張広角・超ローアングルや強い煽り/俯瞰になっていないか",
