...
export function buildSystemPrompt(
  ...
  const unifiedFormat = [
    ...
    "- 【構図・人物サイズ】人物を画面内で主役の大きさに保ち、元画像と近いスケール感を維持する（豆粒化・遠景の点景にしない）。サイズと主役性の表現のみで 1 行（カメラ用語は使わない）。★省略禁止★",
    "- 【体型・頭身】元画像の人物比率を維持し、8頭身前後（広く見て7〜9頭身）の自然な体型に保つ（脚長化・小顔化・胴体縮小・別体型化を避ける）。比率・頭身の表現のみで 1 行。★省略禁止★",
    "- 【人体補正】手は片手5本指で、指・腕・脚のつくりと姿勢・接地のバランスが自然になるよう整える 1 行（日英混在可・やわらかい表現で）。★省略禁止★",
